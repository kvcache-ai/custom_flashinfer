...
def rmsnorm(
    ...
    _rmsnorm(out, input, weight, batch_size_tensor, eps, enable_pdl)
    return out
...
def _rmsnorm(
    ...
    if enable_pdl is None:
        enable_pdl = device_support_pdl(input.device)
    get_module_attr("rmsnorm")(out, input, weight, batch_size_tensor, eps, enable_pdl)
...
def fused_add_rmsnorm(
    ...
    """
    if enable_pdl is None:
        enable_pdl = device_support_pdl(input_tensor.device)
